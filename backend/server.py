...
def call_bedrock(conversation: list[dict], user_message: str) -> str:
    """
    Call AWS Bedrock (Nova) using the Converse API.
    Bedrock supports ONLY 'user' and 'assistant' roles.
    """

    messages = []

    # 1️⃣ Put system prompt INSIDE the first user message
    messages.append({
        "role": "user",
        "content": [
            {
    ...
    # 2️⃣ Add prior conversation (already user/assistant)
